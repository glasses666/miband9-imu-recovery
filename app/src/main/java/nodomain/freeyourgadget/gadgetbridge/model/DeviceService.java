...
public interface DeviceService extends EventHandler {
    ...
    String ACTION_DEBUG_SEND_RAW_BYTES = PREFIX + ".action.debug_send_raw_bytes";
    String ACTION_DEBUG_SEND_RAW_PROTOBUF_COMMAND = PREFIX + ".action.debug_send_raw_protobuf_command";
    ...
    String EXTRA_RAW_BYTES = "raw_bytes";
