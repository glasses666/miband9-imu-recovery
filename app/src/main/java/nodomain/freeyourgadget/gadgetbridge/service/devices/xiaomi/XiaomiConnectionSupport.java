...
public abstract class XiaomiConnectionSupport {
    ...
    public void sendRawBytes(final byte[] bytes, @Nullable final XiaomiCharacteristic.SendCallback callback) {
        throw new UnsupportedOperationException("Raw byte writes are only implemented by RFCOMM/SPP support");
    }
    ...
    public void sendRawProtobufCommandBytes(final String taskName, final byte[] bytes,
        ...
        throw new UnsupportedOperationException("Raw protobuf command writes are only implemented by Xiaomi SPP V2 support");
    }
