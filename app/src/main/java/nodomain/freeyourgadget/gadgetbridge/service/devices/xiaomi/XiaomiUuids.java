...
public class XiaomiUuids {
    ...
    public static final Map<UUID, XiaomiBleUuidSet> BLE_UUIDS = new LinkedHashMap<UUID, XiaomiBleUuidSet>() {{
        ...
        put(UUID.fromString("0000fe95-0000-1000-8000-00805f9b34fb"), new XiaomiBleUuidSet(
                ...
                UUID.fromString("0000005f-0000-1000-8000-00805f9b34fb")
        ));
    ...
    public static class XiaomiBleUuidSet {
        ...
        private final UUID characteristicSarNotify;
        private final UUID characteristicSarWrite;
        ...
        public XiaomiBleUuidSet(final boolean encrypted,
                                ...
                                final UUID characteristicSarNotify,
                                final UUID characteristicSarWrite) {
            ...
            this.characteristicSarNotify = characteristicSarNotify;
            this.characteristicSarWrite = characteristicSarWrite;
        }
        ...
        protected UUID getCharacteristicSarNotify() {
            return characteristicSarNotify;
        }

        protected UUID getCharacteristicSarWrite() {
            return characteristicSarWrite;
        }
    }
}
