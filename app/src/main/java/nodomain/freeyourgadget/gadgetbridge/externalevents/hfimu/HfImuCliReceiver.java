...
public class HfImuCliReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        switch (command) {
            ...
            case HfImuCliContract.COMMAND_MI_FIND_BAND:
            case HfImuCliContract.COMMAND_GAMESIR_PROBE:
            case HfImuCliContract.COMMAND_DFU_STATUS_PROBE:
            case HfImuCliContract.COMMAND_SPORT_XMS_PROBE:
            case HfImuCliContract.COMMAND_GB_SPORT_XMS_OPEN:
            case HfImuCliContract.COMMAND_GB_SPORT_XMS_STOP:
    ...
    private void startCliService(final Context context, final String command, final String requestId, final String nonce,
        ...
        if (sourceIntent != null) {
            ...
            serviceIntent.putExtra(HfImuCliContract.EXTRA_FORCE_CONNECTION_TYPE, sourceIntent.getStringExtra(HfImuCliContract.EXTRA_FORCE_CONNECTION_TYPE));
            ...
            serviceIntent.putExtra(HfImuCliContract.EXTRA_XMS_TIMEZONE, sourceIntent.getStringExtra(HfImuCliContract.EXTRA_XMS_TIMEZONE));
            serviceIntent.putExtra(HfImuCliContract.EXTRA_XMS_SPORT_STATE, sourceIntent.getStringExtra(HfImuCliContract.EXTRA_XMS_SPORT_STATE));
        }
        try {
