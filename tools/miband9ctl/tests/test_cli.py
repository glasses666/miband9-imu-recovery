...
AdapterProperties
  ...
  Bonded devices:
    ...
    AA:BB:CC:DD:EE:02 [ DUAL ] Xiaomi Smart Band 9 808F
...
"""
        ...
        self.assertEqual(
            [
                ...
                {"address": "AA:BB:CC:DD:EE:02", "transport": "DUAL", "name": "Xiaomi Smart Band 9 808F"},
            ],
...
"""
    ...
    def test_parse_known_devices_log_extracts_presence_without_values(self):
        log = (
            ...
            '"device_0_address":"AA:BB:CC:DD:EE:02","device_0_name":"Xiaomi Smart Band 9 808F",'
    ...
    def test_parse_scan_log_extracts_discovered_target_devices(self):
        ...
        self.assertEqual(
            [
                {"address": "AA:BB:CC:DD:EE:02", "name": "Xiaomi Smart Band 9 808F", "bond_state": "NONE"},
    ...
    def test_parse_pair_log_extracts_pair_result(self):
        log = (
            ...
            '"address":"AA:BB:CC:DD:EE:02","name":"Xiaomi Smart Band 9 808F",'
    ...
    def test_parse_sport_xms_probe_log_extracts_binder_sensor_stream(self):
        log = (
            ...
            '"device_name":"Xiaomi Smart Band 9 808F","device_model":"M2346B1","did_present":"true"}\n'
            'I/MI_HFIMU_STATE(123): '
        ...
        self.assertEqual(
            {
                ...
                "device_name": "Xiaomi Smart Band 9 808F",
